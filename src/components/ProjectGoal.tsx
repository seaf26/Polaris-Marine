...
const ProjectGoal: React.FC = () => {
  ...
  return (
    <section className="relative py-20 bg-gradient-to-r from-blue-600 via-blue-400 to-blue-300 dark:from-blue-900 dark:via-blue-800 dark:to-blue-700 overflow-hidden" data-aos="fade-up">
      {/* Decorative SVG wave */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 flex flex-col items-center text-center" data-aos="zoom-in" data-aos-delay="200">
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight drop-shadow-lg">
          <span className="bg-gradient-to-r from-yellow-300 via-blue-200 to-blue-400 bg-clip-text text-transparent">{t('projectGoal')}</span>
        </h2>
        <div className="text-lg md:text-2xl font-semibold text-blue-100 mb-6 drop-shadow">
          <span className="text-yellow-200 font-bold">{t('projectGoalText')}</span>
        </div>
        <p className="text-base md:text-lg text-blue-50 dark:text-blue-100 max-w-2xl mx-auto mb-2">
          {t('projectGoalDesc')}
        </p>
      </div>
